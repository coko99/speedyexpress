      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          datasets: [
            {
              data: paketi,
              backgroundColor: ["rgba(255, 99, 132, 0.6)", "rgba(54, 162, 235, 0.6)", "rgba(54, 162, 54, 0.6)", "rgba(54, 32, 235, 0.6)", "rgba(54, 162, 162, 0.6)", "rgba(0, 162, 235, 0.6)", "rgba(162, 162, 235, 0.6)"],
            },
          ],
          labels: kuriri,
        },
