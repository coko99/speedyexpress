      ...
      var myChart = new Chart(ctx, {
        ...
        data: {
          datasets: [
            {
              data: paketi,
              backgroundColor: ["rgba(255, 99, 132, 0.6)", "rgba(54, 162, 235, 0.6)", "rgba(54, 162, 54, 0.6)", "rgba(54, 32, 235, 0.6)", "rgba(54, 162, 162, 0.6)", "rgba(0, 162, 235, 0.6)", "rgba(162, 162, 235, 0.6)", "rgba(235, 52, 235, 0.6)", "rgba(162, 235, 52, 0.6)", "rgba(130, 235, 52, 0.6)", "rgba(70, 235, 52, 0.6)", "rgba(235, 130, 52, 0.6)", "rgba(235, 60, 52, 0.6)", "rgba(235, 60, 130, 0.6)", "rgba(235, 60, 235, 0.6)"],
            },
          ],
          labels: kuriri,
        },
